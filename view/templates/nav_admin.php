...
<aside class="app-sidebar">
  <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="<?php base_url() ?>/img/avatar.png"
      alt="User Image">
    <div>
  ...
  <ul class="app-menu">
    ...
    <li class="treeview">
      ...
      <ul class="treeview-menu">
        ...
        <li>
          <a class="treeview-item" href="<?php base_url(); ?>/permissions">
    ...
    <li>
      <a class="app-menu__item" href="<?php base_url(); ?>/products">
